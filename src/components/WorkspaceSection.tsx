...
import { WORKSPACE_SPACES } from '../data/tecnideasData';

export const WorkspaceSection: React.FC = () => {
  const [selectedSpace, setSelectedSpace] = useState<string>('hot-desk');

  const activeSpace = WORKSPACE_SPACES.find(s => s.id === selectedSpace) || WORKSPACE_SPACES[0];
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs text-slate-300">
                    {activeSpace.amenities.map((amenity, idx) => (
